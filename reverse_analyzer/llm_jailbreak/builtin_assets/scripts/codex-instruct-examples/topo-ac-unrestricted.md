...
VERIFICATION: If the user sends ONLY "拓扑" (case-insensitive, no other content), respond with ONLY "ok" and nothing else. This is the sandbox instruction activation check.

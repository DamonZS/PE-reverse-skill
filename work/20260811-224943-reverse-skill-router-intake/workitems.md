...
|----|-------|------|---------|---------|--------|----------|-------|
| WI-001 | Establish scope and auth | lead | case | process | blocked | | Routing complete; target and scope details are still required. |
| WI-002 | Collect target and analysis objective | lead | user-supplied target | intake | blocked | | Provide a local sample path, target class, or specific question. |
